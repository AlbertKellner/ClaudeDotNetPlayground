    ...
    ILogger<WeatherConditionsGetUseCase> logger)
{
    ...
    public async Task<WeatherConditionsGetOutput> ExecuteAsync(WeatherConditionsGetInput input, CancellationToken cancellationToken = default)
    {
        ...
        logger.LogInformation(
            ...
            openMeteoInput.Latitude,
            openMeteoInput.Longitude);
