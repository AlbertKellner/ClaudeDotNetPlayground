...
public sealed class WeatherConditionsGetOutput
{
    ...
    public WeatherConditionsGetCurrentUnits CurrentUnits { get; init; } = new();

    [JsonPropertyName("current")]
    public WeatherConditionsGetCurrent Current { get; init; } = new();
}

public sealed class WeatherConditionsGetCurrentUnits
{
...
public sealed class WeatherConditionsGetCurrent
{
    [JsonPropertyName("time")]
    public string Time { get; init; } = string.Empty;
