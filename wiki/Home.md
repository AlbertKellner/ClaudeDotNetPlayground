...
- Busca de ficha completa de Pokémon via PokeAPI (`GET /pokemon-search`)
...
| [Busca de Pokémon](Feature-PokemonSearchGet) | Ficha completa de Pokémon via PokeAPI (`GET /pokemon-search`) |
